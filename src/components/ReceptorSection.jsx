    ...
    <section className="bg-backgroundgrey">
      <div className="container mx-auto lg:flex gap-6 py-16 items-center">
        ...
        <div className="lg:w-1/2 italic text-black text-lg font-thin">
          ...
          <p className="mt-6">By specifically targeting the IL-13 cytokine, Adtralza® inhibits the interaction with type II receptors and prevents IL-13-induced inflammatory responses in the skin(1,2). Adtralza® selectively modulates the dysregulated immune system by(1): </p>
